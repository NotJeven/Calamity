...
tellraw @s {"translate":"system.message","color":"green","with":[{"translate":"arena.calamity.welcome","with":[{"translate":"Unamed Jeven Project","color":"white"},{"translate":"Jeven","underlined": true,"color": "blue","hoverEvent": {"action": "show_text","value": {"translate":"Twitter"}},"clickEvent": {"action": "open_url","value": "https://twitter.com/notjeven"}}]}]}